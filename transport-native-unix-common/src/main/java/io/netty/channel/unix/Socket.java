...
public class Socket extends FileDescriptor {
    ...
    public final void setLongOpt(int level, int optname, long optvalue) throws IOException {
        setLongOpt(fd, level, optname, optvalue);
    }
    ...
    public final long getLongOpt(int level, int optname) throws IOException {
        return getLongOpt(fd, level, optname);
    }
    ...
    private static native void setLongOpt(int fd, int level, int optname, long optvalue) throws IOException;
    ...
    private static native long getLongOpt(int fd, int level, int optname) throws IOException;
